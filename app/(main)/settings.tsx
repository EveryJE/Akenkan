...
import HciSettingsModal from "@/components/general/HciModal";
...
import HciView from "@/components/Views/HciView";
...
const SettingsPage = () => {
 ...
 const showToast = (mes:string) => {
  ...
  return (
    <HciView className=" h-full p-4 pt-0">
      {/* TitleBar  👳🏻‍♂️ */}
        ...
        <View>
          ...
          <View className="gap-2">
            ...
            <View className="flex-row gap-2">
              ...
              <TouchableOpacity activeOpacity={0.9} onPress={()=>onSetFocus()} className="flex-row flex-1">
                <View>
