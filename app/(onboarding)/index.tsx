    ...
    <View className="flex-1 bg-white dark:bg-slate-900">
      ...
      >
        ...
        <OnBoardingPage onSnapTo={handlePageChange} onboardNumber={1}>
          {/* <TextToSpeach/> */}
          <View className="px-8">
            <HciText type="header" className="text-center  font-extrabold text-2xl self-center">
      ...
      <View className="flex-row justify-between absolute w-full top-0 p-8">
        ...
        <TouchableOpacity onPress={() => onSkipToLogIn()}>
          <Text className="text-amber-500">Skip</Text>
        </TouchableOpacity>
      </View>
      ...
      >
        ...
        <Animated.View
          className="-left-[16px] rounded-full w-10 h-3 bg-amber-500 absolute "
          style={[
            {
